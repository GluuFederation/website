...
if($('.l-header').length > 0){
    ...
    var banner = $('.banner-col');
        ...
        banner.css({'min-height':(($(window).height()) - 104)+'px'});//104 is padding top for home-banner-wrapper
  ...
  $(window).scroll(function() {
    var scroll = getCurrentScroll();
      if ( scroll >= shrinkHeader ) {
           //$('#fixedtop').addClass('shrink');
           $('.top-bar-top').slideUp('fast');
           $('.logo').addClass('shrink');
           $('.main-nav-wrapper').addClass('shrink');
           $('.home .top-bar').removeClass('top-bar-transparent');
           $('.home .top-bar').find('.white-logo').css('display','none');
           $('.home .top-bar').find('.green-logo').fadeIn('fast');
           $('.home .fixedtop-wrapper').css('box-shadow','0 1px 7px -3px rgba(0,0,0,.3)');
        }
        else {
            //$('#fixedtop').removeClass('shrink');
            $('.top-bar-top').slideDown('fast');
            $('.logo').removeClass('shrink');
            $('.main-nav-wrapper').removeClass('shrink');
            $('.home .top-bar').addClass('top-bar-transparent');
            $('.home .top-bar').find('.green-logo').css('display','none');
            $('.home .top-bar').find('.white-logo').fadeIn('fast');
            $('.home .fixedtop-wrapper').css('box-shadow','none');
        }
  });
function getCurrentScroll() {
	...
	/*$(window).scroll(function() {
        var $myDiv = $('.main-nav-wrapper');
        var el_height = $('.main-nav-wrapper').height();
        var newH = 0;
